...
namespace Spludlow.MameAO
{
	public class OperationsHtml
	{
		...
		public static int FBNeoMSSQLPayloadHtml(string serverConnectionString, string databaseName)
		{
			using (SqlConnection connection = new SqlConnection(serverConnectionString + $"Initial Catalog='{databaseName}';"))
			{
				...
				SqlCommand datafileCommand = new SqlCommand("UPDATE datafile_payload SET [title] = @title, [html] = @html WHERE [key] = @key", connection);
				datafileCommand.Parameters.Add("@title", SqlDbType.NVarChar);
				datafileCommand.Parameters.Add("@html", SqlDbType.NVarChar);
				datafileCommand.Parameters.Add("@key", SqlDbType.VarChar);

				SqlCommand gameCommand = new SqlCommand("UPDATE game_payload SET [title] = @title, [html] = @html WHERE ([datafile_key] = @datafile_key AND [game_name] = @game_name)", connection);
				...
				gameCommand.Parameters.Add("@game_name", SqlDbType.VarChar);
				...
				try
				{
					foreach (DataRow dataFileRow in datafileTable.Rows)
					{
						...
						foreach (DataRow gameRow in gameTable.Select($"datafile_id = {datafile_id}"))
						{
							...
							gameCommand.Parameters["@title"].Value = game_title;
							gameCommand.Parameters["@html"].Value = game_html.ToString();
							gameCommand.Parameters["@datafile_key"].Value = datafile_key;
							gameCommand.Parameters["@game_name"].Value = game_name;
							gameCommand.ExecuteNonQuery();
						}

						datafile_html.AppendLine("</table>");

						datafileCommand.Parameters["@title"].Value = datafile_title;
						datafileCommand.Parameters["@html"].Value = datafile_html.ToString();
						datafileCommand.Parameters["@key"].Value = datafile_key;
		...
		public static int TosecMSSQLPayloadHtml(string serverConnectionString, string databaseName)
		{
			string version = "XXX";
			...
			using (SqlConnection connection = new SqlConnection(serverConnectionString + $"Initial Catalog='{databaseName}';"))
			{
				...
				SqlCommand categoryCommand = new SqlCommand("UPDATE category_payload SET [title] = @title, [html] = @html WHERE ([category] = @category)", connection);
				categoryCommand.Parameters.Add("@title", SqlDbType.NVarChar);
				categoryCommand.Parameters.Add("@html", SqlDbType.NVarChar);
				categoryCommand.Parameters.Add("@category", SqlDbType.VarChar);

				SqlCommand datafileCommand = new SqlCommand("UPDATE datafile_payload SET [title] = @title, [html] = @html WHERE ([category] = @category AND [name] = @name)", connection);
				datafileCommand.Parameters.Add("@title", SqlDbType.NVarChar);
				datafileCommand.Parameters.Add("@html", SqlDbType.NVarChar);
				datafileCommand.Parameters.Add("@category", SqlDbType.VarChar);
				datafileCommand.Parameters.Add("@name", SqlDbType.VarChar);

				SqlCommand gameCommand = new SqlCommand("UPDATE game_payload SET [title] = @title, [html] = @html WHERE ([category] = @category AND [datafile_name] = @datafile_name AND [game_name] = @game_name)", connection);
				gameCommand.Parameters.Add("@title", SqlDbType.NVarChar);
				gameCommand.Parameters.Add("@html", SqlDbType.NVarChar);
				gameCommand.Parameters.Add("@category", SqlDbType.VarChar);
				gameCommand.Parameters.Add("@datafile_name", SqlDbType.VarChar);
				gameCommand.Parameters.Add("@game_name", SqlDbType.VarChar);
					...
					foreach (string category in new string[] { "TOSEC", "TOSEC-ISO", "TOSEC-PIX" })
					{
						...
						foreach (DataRow datafileRow in datafileTable.Select($"[category] = '{category}'"))
						{
							...
							foreach (DataRow gameRow in gameTable.Select($"[datafile_id] = {datafile_id}"))
							{
								...
								gameCommand.Parameters["@title"].Value = datafile_title;
								gameCommand.Parameters["@html"].Value = datafile_html.ToString();
								gameCommand.Parameters["@category"].Value = category.ToLower();
								gameCommand.Parameters["@datafile_name"].Value = datafile_name;
								gameCommand.Parameters["@game_name"].Value = game_name;
								gameCommand.ExecuteNonQuery();
							...
							datafileCommand.Parameters["@title"].Value = datafile_title;
							datafileCommand.Parameters["@html"].Value = datafile_html.ToString();
							datafileCommand.Parameters["@category"].Value = category.ToLower();
							datafileCommand.Parameters["@name"].Value = datafile_name;
							datafileCommand.ExecuteNonQuery();
						...
						categoryCommand.Parameters["@title"].Value = category_title;
						categoryCommand.Parameters["@html"].Value = category_html.ToString();
						categoryCommand.Parameters["@category"].Value = category.ToLower();
