...
namespace Spludlow.MameAO
{
	public class Settings
	{
		...
		public Dictionary<string, string> OptionDescriptions = new Dictionary<string, string>() {
			...
			{ "MameVersion", "Use the MAME version with Assets available on Archive.Org (recommended), or use the latest on GitHub (WARNING you will need to import the latest assets yourself).<br />" +
				"Restart MAME-AO for this setting to take effect." },
		};
